...
def _generate_image_and_label_batch(image, label, min_queue_examples,
  ...
  """
    ...
    return images, tf.reshape(tf.one_hot(indices=tf.reshape(label_batch, [batch_size,1]), depth=10, on_value=1.0, off_value=0.0, axis=-1),[batch_size,10])
...
def inputs(eval_data, data_dir, batch_size):
  ...
  """
    ...
    with tf.name_scope('input'):
        ...
        # read_input.label = tf.one_hot(indices=read_input.label, depth=10, on_value=1.0, off_value=0.0, axis=-1)
